  ...
  for($i=0;$i<count($array_datos);$i++)
{
	...
	?>
	  <tr>
    <td bgcolor="#FBECC8">Base <? echo $nuevoarray->RescatarCanalSalida(); ?></td>
    <td bgcolor="#FBECC8"><? echo $nuevoarray->RescatarNumero(); ?></td>
    <td bgcolor="#FBECC8"><? echo	$InicioLlamada->mostrar();	?></td>
    <td bgcolor="#FBECC8"><? echo $FinLlamada->mostrar(); ?></td>
    <td bgcolor="#FBECC8"><? echo $nuevoarray->RescatarDuracion(); ?> Segundos </td>

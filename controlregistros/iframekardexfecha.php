  ...
  <tr>
    <td width="625" height="35"><form id="form1" name="form1" method="get" action="">
      <table width="690" border="0" align="center" cellpadding="3" cellspacing="2">
        ...
        <tr>
          <td colspan="5" bgcolor="#990000"><div align="center"><span class="Estilo2 Estilo1"><strong>Consumo de Bases en minutos</strong></span></div></td>
          </tr>
		<tr>
          ...
          <input readonly='true' type='Text' id="fecha1" name="fecha1" value="<? echo $_GET[fecha1] ?>" size="10" onFocus='idfecha1Calendar.showCalendar();'>
            </span>
           <div id="idfecha1CalendarContiner" style='display:none;' class='calendario' ></div>
          <script> 
		idfecha1Calendar = createCalendario( "fecha1", "idfecha1CalendarContiner", "resources/img/", "yyMMdd", "spanish" );
         </script>		 </td>
          ...
          <input readonly='true' type='Text' id="fecha2" name="fecha2" value="<? echo $_GET[fecha2] ?>" size="10" onFocus='idfecha2Calendar.showCalendar();'>
            </span>
           <div id="idfecha2CalendarContiner" style='display:none;' class='calendario' ></div>
          <script> 
		idfecha2Calendar = createCalendario( "fecha2", "idfecha2CalendarContiner", "resources/img/", "yyMMdd", "spanish" );
         </script>		</td>
        </tr>
        <tr>
...
{
if(!(empty($_GET[fecha1])) and !(empty($_GET[fecha2])) and !(empty($_GET[ihora])) and !(empty($_GET[fhora])))
	{
		$fecha1 = $_GET[fecha1];
		$fecha2 = $_GET[fecha2];
		...
		//if($FechaTime1<$FechaTime2){
			...
			include("kardexfechacontrolador.php");
		//}
		/*else
		{
...
function validar()
{
	if(document.form1.fecha1.value!='' && document.form1.fecha2.value!='')
	{
		...
		var fecha2="20"+document.form1.fecha2.value;
		...
		Factual=parseInt(Factual);
			...
			if(Fecha1<=Fecha2)
			{
				...
				{
					alert("La Fecha2 es superior a la fecha actual");
				}
			}
			else
			{
	...
	{
		alert('Debe ingresar una Fecha de inicio y Fecha de fin');
	}
}
</script>
